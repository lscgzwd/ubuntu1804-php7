...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(yimage)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(yimage)
ZEND_DECLARE_MODULE_GLOBALS(yimage)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(yimage_globals_id, zend_yimage_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(yimage_globals_id, zend_yimage_globals *, error_code )
#else
#define SWIG_ErrorMsg() (yimage_globals.error_msg)
#define SWIG_ErrorCode() (yimage_globals.error_code)
#endif
...
static void yimage_init_globals(zend_yimage_globals *globals ) {
...
ZEND_NAMED_FUNCTION(_wrap_swig_yimage_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_swig_yimage_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_YImageClassify) {
  ...
  result = YImageClassify(arg1,arg2);
...
static zend_function_entry yimage_functions[] = {
 SWIG_ZEND_NAMED_FE(yimageclassify,_wrap_YImageClassify,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(yimageentropy,_wrap_YImageEntropy,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(swig_yimage_alter_newobject,_wrap_swig_yimage_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_yimage_get_newobject,_wrap_swig_yimage_get_newobject,NULL)
 ZEND_FE_END
};
...
#endif
zend_module_entry yimage_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"yimage",
    yimage_functions,
    PHP_MINIT(yimage),
    PHP_MSHUTDOWN(yimage),
    PHP_RINIT(yimage),
    PHP_RSHUTDOWN(yimage),
    PHP_MINFO(yimage),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &yimage_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &yimage_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(yimage)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(yimage, yimage_init_globals, NULL);
