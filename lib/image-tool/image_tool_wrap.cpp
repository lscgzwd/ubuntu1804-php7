...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(image_tool)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(image_tool)
ZEND_DECLARE_MODULE_GLOBALS(image_tool)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(image_tool_globals_id, zend_image_tool_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(image_tool_globals_id, zend_image_tool_globals *, error_code )
#else
#define SWIG_ErrorMsg() (image_tool_globals.error_msg)
#define SWIG_ErrorCode() (image_tool_globals.error_code)
#endif
...
static void image_tool_init_globals(zend_image_tool_globals *globals ) {
...
ZEND_NAMED_FUNCTION(_wrap_swig_image_tool_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_swig_image_tool_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_classify_by_line) {
  ...
  result = classify_by_line(arg1,arg2);
...
ZEND_NAMED_FUNCTION(_wrap_extract_black_rectangle) {
  ...
  result = extract_black_rectangle(arg1,arg2);
...
static zend_function_entry image_tool_functions[] = {
 SWIG_ZEND_NAMED_FE(classify_by_line,_wrap_classify_by_line,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(extract_black_rectangle,_wrap_extract_black_rectangle,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(swig_image_tool_alter_newobject,_wrap_swig_image_tool_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_image_tool_get_newobject,_wrap_swig_image_tool_get_newobject,NULL)
 ZEND_FE_END
};
...
zend_module_entry image_tool_module_entry = {
    ...
    PHP_RINIT(image_tool),
    PHP_RSHUTDOWN(image_tool),
    PHP_MINFO(image_tool),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &image_tool_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &image_tool_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(image_tool)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(image_tool, image_tool_init_globals, NULL);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(image_tool_globals_id);
#endif
    return SUCCESS;
}
